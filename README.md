...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-11-26 08:03`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5f45969e-a35c-44c9-a0a6-8a826d9b9bbb.git
$ cd 5f45969e-a35c-44c9-a0a6-8a826d9b9bbb
```
